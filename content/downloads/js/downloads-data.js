...
const downloadsData = [
  ...
  },
  {
    ...
    category: "software",
    description: "PDF Watermark Tool 是一款专业的PDF水印添加工具，支持快速为PDF文档添加自定义水印，保护您的文档版权和机密信息。",
    icon: "💦",
    fileSize: "66.8 MB",
    version: "自研软件",
    downloadCount: 325,
  ...
  },
  {
    ...
    category: "software",
    description: "AE英文界面学习助手是一款专为AE用户设计的桌面应用软件，旨在帮助英文基础薄弱的用户快速熟悉和掌握After Effects英文版界面中的专业术语。",
    icon: "🔤",
    fileSize: "68.6 MB",
    version: "自研软件",
    downloadCount: 975,
